...
namespace UserAddIn
{
    public class Project: SQLObject
    {
        ...
        public List<SQLObject> 
            s => ListPhysicalObject.FindAll(tp => tp.GetType() == typeof(Queue));
        //public List<SQLObject> Route_has_TravelingPoint => ListPhysicalObject.FindAll(tp => tp.GetType() == typeof(Route_has_travelingpoint));
