        ...
        */
        internal new void CreateSimioLink(IDesignContext context, Project project)
        {
            ...
            */
            ...
            {
                pathObject = context.ActiveModel.Facility.IntelligentObjects.CreateLink("Path", (INodeObject)fromNode.INode, ((IFixedObject)toNode.INode).Nodes[0], null) as ILinkObject;
                
            }
            else if (fromNode.Machine!= null && toNode.Travelingpoint != null)
            {
                pathObject = context.ActiveModel.Facility.IntelligentObjects.CreateLink("Path", ((IFixedObject)fromNode.INode).Nodes[0], (INodeObject)toNode.INode, null) as ILinkObject;
            ...
            else if (fromNode.Machine != null && toNode.Machine!= null)
            {
                ...
                pathObject = context.ActiveModel.Facility.IntelligentObjects.CreateLink("Path", ((IFixedObject)fromNode.INode).Nodes[0], ((IFixedObject)toNode.INode).Nodes[0], null) as ILinkObject;
            }
            else
