...
namespace UserAddIn
{
    public class Materialhandlingsystem : SQLObject
    {
        ...
        //Add traveling points to generate them
        protected List<SQLObject> _travelingpoints;
        #endregion
        #region Constructors
        public Materialhandlingsystem(Project project, MySqlDataReader parentReader) : base(project, parentReader)
        {
            ...
            _travelingpoints = new List<SQLObject>();
            command = new MySqlCommand("SELECT * FROM travelingpoint", connection);
            reader = command.ExecuteReader();
            while (reader.Read())
                _travelingpoints.Add(new Travelingpoint(project, reader));
            reader.Close();
            CloseConnection();
        }
        #endregion
        ...
        public List<SQLObject> Travelingpoints
        {
